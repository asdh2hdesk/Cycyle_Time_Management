            ...
            html = """
                        ...
                        <div style="overflow-x: auto; margin-top: 10px;">
                            <div style="margin-bottom: 15px; padding: 10px; background-color: #f0f8ff; border-radius: 5px;">
                                <strong>Configuration Used:</strong> {config.name} 
                                <span style="font-size: 11px; color: #666;">
                                    (Working Days: {config.working_days_per_month}, Shifts/Day: {config.shifts_per_day})
                                </span>
                            </div>
            ...
            for shift in wizard.calculation_id.operation_shift_ids:
                ...
                html += f"""
                    <tr>
                        ...
                        <td style="text-align: center;">{calc_data.get('shift_hours', 0):.2f}</td>
                        ...
                        <td style="text-align: center;">{calc_data.get('volume_per_month', 0):.2f}</td>
                        ...
                        <td style="text-align: center;">{calc_data.get('cycle_time_minutes', 0):.2f}</td>
                        ...
                        <!--  Plant Efficiency  -->
                        <td style="text-align: center;">{calc_data.get('plant_efficiency', 0):.2f}</td>	
